namespace RealESRGAN_GUI
{
    public partial class MainWindow
    {
        ...
        private static string ChineseText(string key) => key switch
        {
            ...
            "PreviewDebugCurrentVersion" => "当前版本",
            "PreviewDebugSimulatedLatestVersion" => "模拟最新版本",
            "PreviewDebugLatestVersion" => "最新版本",
            ...
            "LatestVersion" => "最新版本",
            "NewVersion" => "发现新版本",
            "UpdateCheckFailedShort" => "无法检查更新。",
            "DownloadLatestVersion" => "点击下载最新版本",
            "OpenReleaseFailed" => "无法打开版本发布页面。",
            "AutoCheckUpdates" => "自动检查更新",
            "UpdateCheckIntervalDaily" => "每天一次",
            "UpdateCheckIntervalWeekly" => "每周一次",
            "UpdateCheckIntervalMonthly" => "每月一次",
            "UpdateCheckIntervalStartup" => "每次启动",
            "UpdateCheckIntervalNever" => "从不",
            "Close" => "关闭",
            "InputTitle" => "图片来源",
            "OutputTitle" => "保存位置",
            "OpenFolder" => "打开文件夹",
            ...
            "HintAnimeVideo" => "动漫视频模型处理的是视频帧图片文件夹，不直接读取 mp4/avi/mov；请先把视频拆成 png/jpg/webp 等帧图片。",
            "ModelPhoto" => "照片 / 人像",
            "ModelAnime" => "动漫 / 插画",
            "ModelVideo" => "动漫视频帧",
            "ScaleAuto" => "模型默认（{0}x）",
            ...
            "FrameFormatPng" => "PNG 帧（清晰，推荐）",
            "FrameFormatJpg" => "JPG 帧（文件更小）",
            "FrameFormatWebp" => "WebP 帧（网页友好）",
            ...
            "NoFramesFound" => "输入文件夹中没有支持的视频帧图片 (png/jpg/jpeg/bmp/webp/tif/tiff)。\n当前后端不直接读取 mp4/avi/mov，请先把视频拆成帧图片。",
            ...
            "InputNoFrames" => "未发现支持的视频帧图片",
            "OutputNoFiles" => "暂无输出结果",
            "InputCount" => "发现 {0} 张可处理图片",
            "InputFrameCount" => "发现 {0} 张可处理帧图片",
            "OutputCount" => "已有 {0} 个结果文件",
            "OutputFrameCount" => "已有 {0} 个结果帧文件",
            "StatusReady" => "就绪",
        ...
        private static string EnglishText(string key) => key switch
        {
            ...
            "PreviewDebugCurrentVersion" => "Current version",
            "PreviewDebugSimulatedLatestVersion" => "Simulated latest version",
            "PreviewDebugLatestVersion" => "Latest version",
            ...
            "UpdateCheckFailedShort" => "Could not check for updates.",
            "DownloadLatestVersion" => "Download latest version",
            "OpenReleaseFailed" => "Could not open the release page.",
            "AutoCheckUpdates" => "Auto check updates",
            "UpdateCheckIntervalDaily" => "Once a day",
            "UpdateCheckIntervalWeekly" => "Once a week",
            "UpdateCheckIntervalMonthly" => "Once a month",
            "UpdateCheckIntervalStartup" => "Every launch",
            ...
            "HintAnimeVideo" => "The Anime video model processes folders of video frame images, not mp4/avi/mov directly. Split the video into png/jpg/webp frame images first.",
            "ModelPhoto" => "Photo / portrait",
            "ModelAnime" => "Anime / illustration",
            "ModelVideo" => "Anime video frames",
            ...
            "FrameFormatPng" => "PNG frames (clear, recommended)",
            "FrameFormatJpg" => "JPG frames (smaller files)",
            "FrameFormatWebp" => "WebP frames (web friendly)",
            ...
            "NoFramesFound" => "No supported video frame images were found in the input folder (png/jpg/jpeg/bmp/webp/tif/tiff).\nThe current backend does not read mp4/avi/mov directly; split the video into frame images first.",
            ...
            "InputNoFrames" => "No supported video frame images found",
            "OutputNoFiles" => "No output files yet",
            "InputCount" => "{0} supported images found",
            "InputFrameCount" => "{0} supported frame images found",
            "OutputCount" => "{0} result files already here",
            "OutputFrameCount" => "{0} result frame files already here",
            "StatusReady" => "Ready",
